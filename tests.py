...
class TestBooksCollector:
    ...
    def test_add_new_book_add_book_without_genre(self):
        collector = BooksCollector()
        collector.add_new_book('Стажёры')
        assert collector.get_book_genre('Стажёры') == ''
    ...
    def test_get_books_with_specific_genre_get_books_by_genre(self):
        collector = BooksCollector()
        books = ['Жук в муравейнике', 'Волны гасят ветер', 'Хромая судьба', 'Стажеры']
        for i in books:
        ...
        assert collector.get_books_with_specific_genre('Фантастика') == books

    def test_get_books_genre_get_list_of_books(self):
        collector = BooksCollector()
        books = ['Хромая судьба', 'Стажеры']
        for i in books:
            collector.add_new_book(i)
            collector.set_book_genre(i,'Фантастика')
        collector.add_new_book('Мальтийский сокол')
    ...
    def test_get_books_for_children_list_not_exist_age_rating_books(self):
        ...
        assert 'Дракула' not in collector.get_books_for_children() and 'Мальтийский сокол' not in collector.get_books_for_children()
